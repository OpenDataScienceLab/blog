...
BLOG_AUTHOR = "@esloch"  # (translatable)
BLOG_TITLE = "Open Data Science Blog"  # (translatable)
...
BLOG_EMAIL = "es.loch@gmail.com"
BLOG_DESCRIPTION = "Grande!"  # (translatable)

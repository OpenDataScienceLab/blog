...
SITE_URL = "https://opendatasciencelab.github.io/blog/"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/pages/affiliated_projects/index.html', 'Affiliated Projects'),
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by         <a href="http://opendatasciencelab.com/" rel="nofollow">Ivan</a>         {license}'
